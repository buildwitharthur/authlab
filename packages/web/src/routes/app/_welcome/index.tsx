...
export const Route = createFileRoute('/app/_welcome/')({
    head: () => ({ meta: [{ title: 'Mural de membros | AuthLab' }] }),
            ...
            >
                <div className="min-w-0">
                    ...
                    <Text className="mt-6.5 max-w-167.5 text-base leading-[1.75]">
                        {user?.name.split(' ')[0]}, obrigado por entrar. Cada
                        pessoa abaixo chegou aqui em um momento diferente, mas
                        todas passaram pela mesma porta.
                    </Text>
                </div>
